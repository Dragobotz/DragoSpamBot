...
from DragoSpamBot.utils import load_plugins
import logging
...
deadly = "🎉 Successfully Deployed Drago SpamBot 🎉 @DragoSpamBot Enjoy! Do visit @DragoXServer"
print(deadly[0: ])
