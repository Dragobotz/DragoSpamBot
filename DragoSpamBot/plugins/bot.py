...
import git
import heroku3
# Changed root to DragoSpamBot
from DragoSpamBot import BOT0, BOT1, BOT2, BOT3, BOT4, BOT5, BOT6, BOT7, BOT8, BOT9
from DragoSpamBot import OWNER_ID, SUDO_USERS, HEROKU_APP_NAME, HEROKU_API_KEY, deadlyversion
from DragoSpamBot import CMD_HNDLR as hl
from telethon.tl.functions.users import GetFullUserRequest
# alive Pic By Default It's Will Show Our
from DragoSpamBot import ALIVE_PIC
from telethon import events, version, Button
from telethon.tl.custom import button
from time import time
from datetime import datetime

DEAD_PIC = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/b65785536183c1ffb2279.jpg"
  

DEADLY = "✯ 𝗗𝗿𝗮𝗴𝗼 𝗦𝗽𝗮𝗺 𝗛𝗲𝗿𝗲 ✯\n\n"
DEADLY += f"═══════════════════\n"
DEADLY += f"• **ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `3.10.1`\n"
DEADLY += f"• **ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ** : `{version.__version__}`\n"
DEADLY += f"• **ᴅʀᴀɢᴏsᴘᴀᴍ ᴠᴇʀsɪᴏɴ**  : `{deadlyversion}`\n"
DEADLY += f"═══════════════════\n\n"   
...
async def alive(event):
  if event.sender_id in SUDO_USERS:
     await BOT0.send_file(event.chat_id,
                                  ...
                                  buttons=[
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/DragoXserver"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/DragoXServerChat")
        ],
        [
        Button.url("• ʀᴇᴘᴏ •", "https://github.com/Dragobotz/DragoSpamBot")
        ]
        ]
        )
