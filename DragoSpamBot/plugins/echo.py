...
from resources.data import GROUP, DragoSpamBot
from DragoSpamBot.sql.echo_sql import addecho, get_all_echos, is_echo, remove_echo
  ...
  if event.sender_id in SUDO_USERS:
     if event.reply_to_msg_id is not None:
            ...
            if int(user_id) in DragoSpamBot:
                    text = f"I Can't Echo @DragoSpamBot Owner"
